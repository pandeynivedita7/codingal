class Main123 {
    public static void main(String[] args) {
        ...
        System.out.println("Uninary Operator" + (a++));// a 11
        System.out.println("Uninary Operator" + (++a));// a 12
        System.out.println("Uninary Operator" + (++b));
        System.out.println("Binary Operator");
        System.out.println("1+2 " + 1 + 2);// + add and string cont " string"
        System.out.println("1+2 " + (1 + 2));// ( become number 1+2) +1+2 string
        ...
        System.out.println("Ternany Operator");// condition ? value_if_true : value_if_false;
        int largestNumber = (a > b) ? a : b; // a=10 b=20 false
