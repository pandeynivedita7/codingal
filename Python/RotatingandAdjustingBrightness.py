...
import numpy as np # array pixels
import matplotlib.pyplot as plt#graphs, images, and visualizations

image = cv2.imread('road.jpg')# dot access 
...
rotated = cv2.warpAffine(image, M, (w, h))#Applies the rotation transformation to the image.
