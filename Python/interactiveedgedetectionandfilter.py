import cv2# computetr vision library
import numpy as np# array manipulation library pixel values of image colour
import matplotlib.pyplot as plt# plotting library for displaying images seaborn

def display_image(title, image):
    """Utility function to display an image."""
    plt.figure(figsize=(8, 8))
    if len(image.shape) == 2:  # Grayscale image
        plt.imshow(image, cmap='gray')# colormap gray for grayscale images
    else:  # Color image
...
interactive_edge_detection('road.jpg')
