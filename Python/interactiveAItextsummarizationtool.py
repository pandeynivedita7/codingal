...
DEFAULT_MODEL = "google/pegasus-xsum"#A default summarization model. You can change this to any model path on Hugging Face (e.g., facebook/bart-large-cnn). Note: different models may return different JSON structures.
...
if __name__ == "__main__":
    ...
    user_name = input("Your name: ").strip()# remove white space
    if not user_name:
        user_name = "User"
