...
while True:
    ...
    hsv = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)# skin detection colour based filtering

    # Define the range for skin color in HSV
    #detecting human skin tones in images/videos, especially in varied lighting conditions.
    lower_skin = np.array([0, 20, 70], dtype=np.uint8)
    upper_skin = np.array([20, 255, 255], dtype=np.uint8)
    #h(0,20)=red and orange 0-179
    #s(20,255)20 desaturated 255 fully
    #v(70,255)brightness
