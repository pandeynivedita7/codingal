...
# Timestamp to avoid multiple triggers
last_action_time = 0
...
def apply_filter(frame, filter_type):
    ...
    elif filter_type == 'SEPIA':#warm brownish tone vintage
...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Draw landmarks  DRAW CIRCLES ON EACH FINGERTIP
            ...
            current_time = time.time()#Stores current timestamp to check time gap between actions.

            # Gesture: Thumb touches Index finger -> Capture photo
            ...
            # Gesture: Thumb touches any other finger -> Change filter
    ...
    # Apply and display the current filter
