...
face_cascade = cv2.CascadeClassifier(cv2.data.haarcascades + 'haarcascade_frontalface_default.xml')# haar pertrained model
...
while True:
    ...
    if cv2.waitKey(1) & 0xFF == ord('q'):# bitwise operator and 
        break
