class Library:
    ...
    def __init__(self, list_of_books, name):#init method
        self.booksList = list_of_books
        self.name = name
        self.lendDict = {}#key:value {key:value}

    def displayBooks(self):#method
        print(f"We have the following books in our library: {self.name}")
        for book in self.booksList:#for loop travel for
            print(book)

    def lendBook(self, user, book):#method
